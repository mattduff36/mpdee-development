...
describe('Contact Component', () => {
  ...
  it('validates project details length', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText(/project details must be less than 1000 characters/i)).toBeInTheDocument();
    });
  });
  ...
  it('submits form successfully', async () => {
    ...
    fireEvent.change(projectDetailsInput, { target: { value: 'I need a website' } });
